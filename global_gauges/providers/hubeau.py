...
class HubeauProvider(BaseProvider):
    ...
    name = "hubeau"
    quality_map = {"Bonne": QualityFlag.GOOD, "Douteuse": QualityFlag.SUSPECT} # Good or Dubious lol
    ...
    def _download_station_info(self) -> None:
        ...
        df = fetch_paginated_data(base_url, {"size":10000})
    ...
    def _download_daily_values(self, site_id: str, start: pd.Timestamp, misc: dict) -> pd.DataFrame:
        ...
        df = fetch_paginated_data(base_url, parameters)
